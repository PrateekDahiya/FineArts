    ...
    return (
        <div className="grid-container">
            ...
            <div className="grid-item topimg">
                <img src={img1} alt="grid-item 1" draggable="false" />
            </div>
            <div></div>
            <div></div>
            <div className="grid-item botimg">
                <img src={img2} alt="grid-item 2" draggable="false" />
            </div>
            <div className="grid-item bigimg">
                <img src={img3} alt="grid-item 3" draggable="false" />
            </div>
            <div className="grid-item topimg">
                <img src={img4} alt="grid-item 4" draggable="false" />
            </div>
            <div></div>
            <div></div>
            <div className="grid-item botimg">
                <img src={img5} alt="grid-item 5" draggable="false" />
            </div>
            <div className="grid-item bigimg">
                <img src={img6} alt="grid-item 6" draggable="false" />
            </div>
            <div className="grid-item topimg">
                <img src={img7} alt="grid-item 7" draggable="false" />
            </div>
            <div></div>
            <div></div>
            <div className="grid-item botimg">
                <img src={img8} alt="grid-item 8" draggable="false" />
            </div>
            <div></div>
        </div>
    );
